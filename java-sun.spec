...
#Source0:	ftp://128.167.104.34/pub/j2sdk/1.3.1/oeiqt1298/j2sdk-1_3_1_02-linux-i386.bin
NoSource:	0
...
cp -rf bin demo include-old lib $RPM_BUILD_ROOT%{jdkdir}
cp -rf include/* $RPM_BUILD_ROOT%{_includedir}/jdk
#cp -rf include-old/* $RPM_BUILD_ROOT%{_includedir}/jdk/old
...
mv -f jre/lib/i386/classic/Xusage.txt jre/Xusage.classic
...
for i in java keytool policytool rmid rmiregistry tnameserv ; do
	ln -sf %{jredir}/bin/$i $RPM_BUILD_ROOT%{_bindir}/$i
done

for i in appletviewer extcheck idlj jar jarsigner javac javah javap jdb \
	native2ascii oldjava oldjavac oldjdb rmic serialver ; do
...
install -d $RPM_BUILD_ROOT{%{mozilladir}/plugins,%{jredir}/plugin/i386/ns600}
install jre/plugin/i386/ns600/libjavaplugin_oji.so \
	$RPM_BUILD_ROOT%{jredir}/plugin/i386/ns600
ln -sf %{jredir}/plugin/i386/ns600/libjavaplugin_oji.so \
...
%attr(755,root,root) %{_bindir}/oldjava
...
%dir %{jdkdir}/lib/*.jar
%dir %{jdkdir}/lib/*.idl
%attr(755,root,root) %{jdkdir}/lib/i386
%{jdkdir}/jre
%{_mandir}/man1/*
...
%defattr(644,root,root,755)
%dir %{jredir}/plugin/i386/ns600
%attr(755,root,root) %{jredir}/plugin/i386/ns600/libjavaplugin_oji.so
